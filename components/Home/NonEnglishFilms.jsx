...
const NonEnglishFilms = ({ data }) => {

    return (
        <View className="space-y-3 pb-5">
            <View className="flex-row justify-between px-4 items-center">
                <Text className="text-[#F00000] font-semibold">Popular Movies</Text>
...
export default NonEnglishFilms
        ...
        <View style={{
            ...
            <LinearGradient style={{
                ...
                <View className="space-y-2">
                    <Text numberOfLines={1} className="text-white">{item.name}</Text>
