...
const IMG_WIDTH = RESPONSIVE_WIDTH * 0.8
const IMG_HEIGHT = IMG_WIDTH * ( 479/ 851)
    ...
    return (
        <View className="space-y-3 pb-5">
            <View className="flex-row justify-between px-4 items-center">
                <Text className="text-[#F00000] font-semibold">Popular Shows</Text>
    ...
    return (
        <View style={{
            ...
            <Image style={{
                width: IMG_WIDTH,
                height: IMG_HEIGHT
            }} source={{ uri: item.boxart.horizontal }} />
